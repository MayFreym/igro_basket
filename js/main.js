...
(() => {
  ...
  document.addEventListener("click", (e) => {
    ...
    // Клик внутри подсказки не должен её закрывать. Работу делает return;
    // e.stopPropagation() мёртв — слушатель на document, всплывать некуда.
    // Закомментирован, не удалён: понадобится, если слушатель переедет с
    // document на конкретный контейнер.
